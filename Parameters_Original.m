...
LH2Model.totalmass10 = 4000;        % [kg] estimated inital total mass (liquid + vapor) !! MAKE SURE YOU DON'T EXCEED CAPACITY AT LIQUID DENSITY: HERE ~ 4000 kg !!
...
LH2Model.STBoiloffrate = 0.0/dayTosec; % [%] flowrate as a %/s of the total liquid mass. DESACTIVATED.
...
LH2Model.ETBoiloffrate = 0.0/dayTosec; % [%] flowrate as a %/s of the total liquid mass. DESACTIVATED.
...
LH2Model.p_ET_final = 45*psiToPa;      % [Pa] final venting pressure for (ET) (= pressure in the truck's tank before leaving the station)
...
if HydrogenTransfer==0      % If hydrogen transfer is deactivated, duration is set
    ...
    LH2Model.tFinal = 60*60;  % [s] Simulation final time (adaptative with ET volume and fill percentage)
