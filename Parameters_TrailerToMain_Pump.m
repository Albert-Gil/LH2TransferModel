...
if HydrogenTransfer==0      % If hydrogen transfer is deactivated, duration is set
    ...
    LH2Model.tFinal = .7*60*60*(LH2Model.VTotal2/12.5)*(LH2Model.TopET-LH2Model.pct_hL20)*(30*kgminTokgsec/LH2Model.PumpMassTransferFast);  % [s] Simulation final time (adaptative with ET volume and fill percentage)
